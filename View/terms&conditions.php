...
<?php include_once('headerpublic.php');?>
    ...
    <h3>Terms and Conditions for Hotel Car and Bus Ticket Booking System</h3>
                    ...
                    <p>Users may need to register and create an account to access certain features. It is the user's responsibility to keep their password confidential. Any actions done from a user's account will be attributed to that user.</p>
                    <h4>3. Use of Service:</h4>
                    <p>This website provides an online platform for users to book hotels and rent cars. All bookings are subject to availability.</p>
                    <h4>4. Payment:</h4> 
